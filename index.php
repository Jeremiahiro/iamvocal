...
<body style="background-color: #0000ff;" data-mobile-nav-trigger-alignment="right" data-mobile-nav-align="left" data-mobile-nav-style="modern" data-mobile-nav-shceme="gray" data-mobile-header-scheme="gray" data-mobile-nav-breakpoint="1199">
	...
	<div id="wrap">
		...
		<header style="background-color: #0000ff !important;" class="main-header main-header-overlay" data-react-to-megamenu="true" data-sticky-header="true" data-sticky-options='{ "stickyTrigger": "first-section" }'>
			...
			<div class="mainbar-wrap">
				<div class="container-fluid" style="background-color:  #0000ff !important;;">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
							<div style="background-color: #0000ff !important;" class="">
								...
								<button style="margin-bottom: 30px !important;" type="button" class="navbar-toggle collapsed nav-trigger style-mobile" data-toggle="collapse" data-target="#main-header-collapse" aria-expanded="false" data-changeclassnames='{ "html": "mobile-nav-activated overflow-hidden" }'>
							...
							<div class="col text-right">
								...
								<div class="header-module">
									...
									<button style="bottom: 30px !important; " class="nav-trigger collapsed style-1 fill-solid scheme-light txt-left main-nav-trigger" role="button"
										...
										<span style=" background-color:  #0000ff !important;" class="bars">
											<span class="bar"></span>
											<span class="bar"></span>
											<span class="bar"></span>
										</span>
		...
		<main id="content" class="content">
			...
			<section  style="background-color: #0000ff;" class="vc_row bg-cover bg-center fullheight d-flex align-items-center">

				<span style="background-color: #0000ff;" class="row-bg-loader"></span>

				<div class="container-fluid">
					<div class="row d-flex flex-wrap align-items-center">
						
						<form action="#" style="width: 100%;">
							<div id="question1" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 questions">
								<div class="lqd-column text-center text-md-center" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":"1200","startDelay":"1500","delay":100,"easing":"easeOutQuint","direction":"forward","initValues":{"scaleX":0.25,"scaleY":0.25,"opacity":0},"animations":{"scaleX":1,"scaleY":1,"opacity":1}}'>
										
									<button style="background-color: #0000ff !important; border: 0px!important;" id="next">
										<img src="assets/img/icon/question1.png">
									</button>
								</div>
								<div class="lqd-column text-center text-md-center" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":"1200","startDelay":"1500","delay":100,"easing":"easeOutQuint","direction":"forward","initValues":{"scaleX":0.25,"scaleY":0.25,"opacity":0},"animations":{"scaleX":1,"scaleY":1,"opacity":1}}'>
		...
		<footer class="main-footer bg-charade pt-10" data-sticky-footer="true">

			<section class=" pb-15 ">
				<div class="container-fluid">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 nopadding">
							<div class="lqd-column text-left">
								<p class="my-0"><span style="font-size: 12px;">VOICES © 2020 I AM VOCAL, All rights reserved.</span></p>
							</div>
							
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 nopadding">
							
								<ul class="lqd-custom-menu text-right reset-ul inline-nav">
